...
const InvestigasiInsiden = function (investigasiinsiden) {
	...
	this.route_couse = investigasiinsiden.route_couse;
	...
	this.bukti_pendukung_lainnya = investigasiinsiden.bukti_pendukung_lainnya;
...
InvestigasiInsiden.getAll = async (param, result, cabang_id) => {
	...
	if (param.q) {
		...
		wheres += `LOWER(a."approval_status_id") LIKE ('%${param.q}%') OR LOWER(a."enable") LIKE ('%${param.q}%') OR LOWER(a."no_report") LIKE ('%${param.q}%') OR LOWER(a."unit_terkait") LIKE ('%${param.q}%') OR LOWER(a."judul_report") LIKE ('%${param.q}%') OR LOWER(a."kronologi_kejadian") LIKE ('%${param.q}%') OR LOWER(a."temuan_investigasi") LIKE ('%${param.q}%') OR LOWER(a."bukti_temuan") LIKE ('%${param.q}%') OR LOWER(a."saksi_1") LIKE ('%${param.q}%') OR LOWER(a."saksi_2") LIKE ('%${param.q}%') OR LOWER(a."investigator") LIKE ('%${param.q}%') OR LOWER(a."rincian_kegiatan") LIKE ('%${param.q}%') OR LOWER(a."luka_sakit") LIKE ('%${param.q}%') OR LOWER(a."wujud_cedera") LIKE ('%${param.q}%') OR LOWER(a."bagian_tubuh_cedera") LIKE ('%${param.q}%') OR LOWER(a."mekanisme_cedera") LIKE ('%${param.q}%') OR LOWER(a."kerusakan_alat") LIKE ('%${param.q}%') OR LOWER(a."uraian_kejadian") LIKE ('%${param.q}%') OR LOWER(a."analisa_penyebab") LIKE ('%${param.q}%') OR LOWER(a."peralatan_kelengkapan") LIKE ('%${param.q}%') OR LOWER(a."alat_pelindung_diri") LIKE ('%${param.q}%') OR LOWER(a."perilaku") LIKE ('%${param.q}%') OR LOWER(a."kebersihan_kerapihan") LIKE ('%${param.q}%') OR LOWER(a."peralatan_perlengkapan") LIKE ('%${param.q}%') OR LOWER(a."kemampuan_kondisi_fisik") LIKE ('%${param.q}%') OR LOWER(a."pemeliharaan_perbaikan") LIKE ('%${param.q}%') OR LOWER(a."design") LIKE ('%${param.q}%') OR LOWER(a."tingkat_kemampuan") LIKE ('%${param.q}%') OR LOWER(a."penjagaan") LIKE ('%${param.q}%') OR LOWER(a."tindakan_terkait") LIKE ('%${param.q}%') OR LOWER(a."faktor_utama_insiden") LIKE ('%${param.q}%') OR LOWER(a."rekomendasi_tindakan") LIKE ('%${param.q}%') OR LOWER(a."pihak_yang_bertanggungjawab") LIKE ('%${param.q}%') OR LOWER(a."pelaksana") LIKE ('%${param.q}%') OR LOWER(a."tanggal_pemeriksaan") LIKE ('%${param.q}%') OR LOWER(a4."nama") LIKE ('%${param.q}%') OR LOWER(a."jabatan") LIKE ('%${param.q}%') OR LOWER(a."status_investigasi_insiden_id") LIKE ('%${param.q}%') OR LOWER(a."prepard_by") LIKE ('%${param.q}%') OR LOWER(a."prepard_tanggal") LIKE ('%${param.q}%') OR LOWER(a."reviewed_by") LIKE ('%${param.q}%') OR LOWER(a."reviewed_tanggal") LIKE ('%${param.q}%') OR LOWER(a."approved_by") LIKE ('%${param.q}%') OR LOWER(a."approved_tanggal") LIKE ('%${param.q}%') OR LOWER(a."cabang_id") LIKE ('%${param.q}%') OR LOWER(a."peralatan_kelengkapan_lainnya") LIKE ('%${param.q}%') OR LOWER(a."alat_pelindung_diri_lainnya") LIKE ('%${param.q}%') OR LOWER(a."perilaku_lainnya") LIKE ('%${param.q}%') OR LOWER(a."kebersihan_kerapihan_lainnya") LIKE ('%${param.q}%') OR LOWER(a."rincian_kegiatan_lainnya") LIKE ('%${param.q}%') OR LOWER(a."peralatan_perlengkapan_lainnya") LIKE ('%${param.q}%') OR LOWER(a."pemeliharaan_perbaikan_lainnya") LIKE ('%${param.q}%') OR LOWER(a."kemampuan_kondisi_fisik_lain") LIKE ('%${param.q}%') OR LOWER(a."kebersihan_kerapihan_lain") LIKE ('%${param.q}%') OR LOWER(a."tingkat_kemampuan_lainnya") LIKE ('%${param.q}%') OR LOWER(a."penjagaan_lainnya") LIKE ('%${param.q}%') OR LOWER(a."tindakan_terkait_lainnya") LIKE ('%${param.q}%')`;
		wheres += ")";
	}
...
InvestigasiInsiden.updateById = async (id, investigasiinsiden, result, user_id) => {
	...
	if (investigasiinsiden.investigasi_insiden_tim) {
