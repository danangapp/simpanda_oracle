...
MstBktKepil.updateById = async(id, mstbktkepil, result, user_id) => {
	...
	objek.keterangan = mstbktkepil.keterangan;
	objek.item = "mstbktkepil";
	objek.user_id = user_id;
	if(mstbktkepil.approval_status_id == 1){
		objek.remark = "Pengajuan disetujui oleh pusat";
	}else if(mstbktkepil.approval_status_id == 2){
		objek.remark = "Pengajuan ditolak oleh pusat";
	}else if(mstbktkepil.approval_status_id == 0){
