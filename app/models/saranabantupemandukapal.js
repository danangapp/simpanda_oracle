...
SaranaBantuPemanduKapal.updateById = async(id, saranabantupemandukapal, result, user_id) => {
	...
	objek.keterangan = saranabantupemandukapal.keterangan;
	objek.item = "saranabantupemandukapal";
	objek.user_id = user_id;
	if(saranabantupemandukapal.approval_status_id == 1){
		objek.remark = "Pengajuan disetujui oleh pusat";
	}else if(saranabantupemandukapal.approval_status_id == 2){
		objek.remark = "Pengajuan ditolak oleh pusat";
	}else if(saranabantupemandukapal.approval_status_id == 0){
