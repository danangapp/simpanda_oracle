...
SaranaBantuPemanduKapal.create = async(newSaranaBantuPemanduKapal, result) => {
		newSaranaBantuPemanduKapal.id = "sarana_bantu_pemandu_kapal_seq.nextval"
		const hv = f.headerValue(newSaranaBantuPemanduKapal);
...
SaranaBantuPemanduKapal.getAll = async (param, result) => {
