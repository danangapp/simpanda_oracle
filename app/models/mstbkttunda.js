...
MstBktTunda.updateById = async(id, mstbkttunda, result, user_id) => {
	...
	objek.keterangan = mstbkttunda.keterangan;
	objek.item = "mstbkttunda";
	objek.user_id = user_id;
	if(mstbkttunda.approval_status_id == 1){
		objek.remark = "Pengajuan disetujui oleh pusat";
	}else if(mstbkttunda.approval_status_id == 2){
		objek.remark = "Pengajuan ditolak oleh pusat";
	}else if(mstbkttunda.approval_status_id == 0){
