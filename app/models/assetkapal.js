...
AssetKapal.findById = async (id, result) => {
	...
	var queryText = "SELECT a.* , a1.\"nama\" as \"cabang\", a2.\"flag\" as \"tipe_asset\", a3.\"nama\" as \"ena\", a4.\"nama\" as \"approval_status\" , a2.\"nama\" as \"jenis_asset\" FROM \"asset_kapal\" a  LEFT JOIN \"cabang\" a1 ON a.\"cabang_id\" = a1.\"id\"  LEFT JOIN \"tipe_asset\" a2 ON a.\"tipe_asset_id\" = a2.\"id\"  LEFT JOIN \"enable\" a3 ON a.\"enable\" = a3.\"id\"  LEFT JOIN \"approval_status\" a4 ON a.\"approval_status_id\" = a4.\"id\"   WHERE a.\"id\" = '" + id + "'";
...
AssetKapal.getAll = async (param, result, cabang_id) => {
    ...
    var query = "SELECT a.* , a1.\"nama\" as \"cabang\", a2.\"flag\" as \"tipe_asset\", a3.\"nama\" as \"ena\", a4.\"nama\" as \"approval_status\" , a2.\"nama\" as \"jenis_asset\" FROM \"asset_kapal\" a  LEFT JOIN \"cabang\" a1 ON a.\"cabang_id\" = a1.\"id\"  LEFT JOIN \"tipe_asset\" a2 ON a.\"tipe_asset_id\" = a2.\"id\"  LEFT JOIN \"enable\" a3 ON a.\"enable\" = a3.\"id\"  LEFT JOIN \"approval_status\" a4 ON a.\"approval_status_id\" = a4.\"id\" ";
	if (param.q) {
