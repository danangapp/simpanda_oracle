...
User.login = async (req, result) => {
	...
	query = `SELECT c."config", c."parent", c."id", c."url" FROM "user" a INNER JOIN "user_access" b ON a."user_group_id" = b."user_group_id" INNER JOIN "menu" c ON b."menu_id" = c."id" WHERE a."id" = '${rows.id}'`;
