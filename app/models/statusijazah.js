...
StatusIjazah.updateById = async(id, statusijazah, result, user_id) => {
	...
	objek.keterangan = statusijazah.keterangan;
	objek.item = "statusijazah";
	objek.user_id = user_id;
	if(statusijazah.approval_status_id == 1){
		objek.remark = "Pengajuan disetujui oleh pusat";
	}else if(statusijazah.approval_status_id == 2){
		objek.remark = "Pengajuan ditolak oleh pusat";
	}else if(statusijazah.approval_status_id == 0){
