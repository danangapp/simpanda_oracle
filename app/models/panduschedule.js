...
PanduSchedule.findById = async (id, result) => {
	...
	console.log("SELECT a.\"id\", a.\"personil_id\", TO_CHAR(a.\"from\", 'HH24:MI') AS \"from\", TO_CHAR(a.\"to\", 'HH24:MI') AS \"to\", a.\"kehadiran\", a.\"keterangan\" FROM \"pandu_jaga\" a WHERE a.\"pandu_schedule_id\" = '" + id + "'");
